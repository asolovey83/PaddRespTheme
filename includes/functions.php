...
function extstyles_setup() {
    wp_enqueue_style('fontawesome', '//use.fontawesome.com/releases/v5.8.1/css/all.css');
    
}

add_action('wp_enqueue_scripts', 'extstyles_setup');
...
<ul class="socialnet">
	<li class="facebook">
		<?php echo sprintf(__('<a rel="nofollow" href="%s"></a>', PADD_THEME_SLUG), $fburl); ?>
	</li>
	<li class="twitter">
		<?php echo sprintf(__('<a rel="nofollow" href="%s"></a>', PADD_THEME_SLUG), $padd_socialnet['twitter']); ?>

	<li class="gplus">
		<?php echo sprintf(__('<a rel="author" href="https://plus.google.com/116099623221409174144"></a>', PADD_THEME_SLUG), $padd_socialnet['gplus']); ?>
	</li>

	</li>
	<li class="rss">
		<?php echo sprintf(__('<a href="%s"></a>', PADD_THEME_SLUG), $padd_socialnet['feedburner']); ?>
	</li>
...
$first_img = "http://url_image_default.jpg";
}
return $first_img;
}